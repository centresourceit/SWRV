...
/**
 * Loader function that retrieves the platforms data from the server.
 * @param {LoaderArgs} props - The loader arguments.
 * @returns {Promise<{ platforms: any }>} - A promise that resolves to an object containing the platforms data.
 */
export const loader: LoaderFunction = async (props: LoaderArgs) => {
    ...
    return json({ platforms: platforms.data.data });
}



const Platforms = () => {
    const platforms = useLoaderData().platforms;
    const pagination = usePagination(platforms);
    ...
    /**
     * Renders a component that displays a modal with information about a specific item.
    ...
    return (
        <>
            ...
            <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
                <div className="flex">
                    <h1 className="text-white font-medium text-xl">Platforms</h1>
                ...
                <div className="overflow-x-hidden no-scrollbar">
                    <div className="bg-[#31353f]  rounded-md flex px-4 py-2 my-2 text-white font-medium text-md flex-nowrap">
                        ...
                        <div className="w-44">Platforms</div>
                        <div className="grow"></div>
                        ...
                        pagination.paginatedItems.map((val: any, index: number) => {
                            return (
                                <div key={index} className="bg-[#31353f] hover:bg-slate-800 rounded-md flex px-4 py-2 my-2 text-white font-medium text-md flex-nowrap">
                                    ...
                                    <div className="w-20"></div>
                                    <div className="w-44">{val.platformName}</div>
                                    <div className="grow"></div>
                                    <div className="w-44">
                                        <img className="w-8 h-8 object-cover object-center" src={val.platformLogoUrl} alt="logo" />
                                    </div>
                                    {/* <div className="grow"></div>
