...
/**
 * Loader function that retrieves the country data from the server.
 * @param {LoaderArgs} props - The loader arguments.
 * @returns {Promise<{ country: string }>} - A promise that resolves to an object containing the country data.
 */
export const loader: LoaderFunction = async (props: LoaderArgs) => {
    ...
    return json({ country: country.data.data });
}



const Country = () => {
    const country = useLoaderData().country;
    const pagination = usePagination(country);
    ...
    return (
        <>
            ...
            <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
                <div className="flex">
                    <h1 className="text-white font-medium text-xl">Country</h1>
