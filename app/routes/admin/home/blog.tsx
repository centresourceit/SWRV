 ...
 * @returns A JSON response containing the data retrieved from the server.
 */
...
const BLOG = () => {
  ...
  const search = async () => {
    ...
    const data = await axios.post(`${BaseUrl}/api/search-neb`, { search: searchRef.current?.value, type: 1 });
      ...
      <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
        <div className="flex">
          ...
          <div className="flex items-center gap-2 w-full">
            <h1 className="text-white font-medium text-xl">BLOG</h1>
