import { faFill, faTrash, faXmark } from "@fortawesome/free-solid-svg-icons";
...
/**
 * Loader function that retrieves a dispute from the server and returns it as JSON.
 * @param {LoaderArgs} props - The loader arguments.
 * @returns {Promise<LoaderResult>} A promise that resolves to the dispute data.
 */
...
const Contact = () => {
  ...
  const pagination = usePagination(dispute);
  ...
  /**
   * Renders a component that displays a modal with information about a campaign type.
            ...
            return (
              ...
              >
                <div className="flex gap-4 w-full items-center">
                  ...
                  />
                  <div>
                    <p className="text-sm">{val.userName.toString().split("@")[0]}</p>
                    <p className="text-sm">{val.userEmail}</p>
                  </div>
                </div>
                <div className="mt-4">
                  {Number(val.isbrand) ? (
                    <div className="w-24 py-1 text-white text-sm bg-green-500 text-center rounded-md font-medium">
                      Brand
                    </div>
                  ) : (
                    <div className="w-24 py-1 text-white text-sm bg-rose-500 text-center rounded-md font-medium">
                      Influencer
                    </div>
                  )}
                </div>
