...
/**
 * Loader function that retrieves the language data from the server.
 * @param {LoaderArgs} props - The loader arguments.
 * @returns A promise that resolves to the language data.
 */
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  return json({ language: language.data.data });
};

const Language = () => {
  const language = useLoaderData().language;
  const pagination = usePagination(language);
  ...
  /**
   * Edit the data for a specific category by making a POST request to the server.
  ...
  return (
    <>
      ...
      <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
        <div className="flex">
          <h1 className="text-white font-medium text-xl">Language</h1>
        ...
        <div className="overflow-x-hidden no-scrollbar">
          <div className="bg-[#31353f]  rounded-md flex px-4 py-2 my-2 text-white font-medium text-md flex-nowrap">
            ...
            <div className="w-44">Language</div>
            <div className="grow"></div>
          ...
          {pagination.paginatedItems.map((val: any, index: number) => {
            return (
              ...
              >
                ...
                <div className="w-20"></div>
                <div className="w-44">{val.languageName}</div>
                <div className="grow"></div>
                <div className="w-44">{he.decode(val.languageAsciiSymbol)}</div>
                {/* <div className="grow"></div>
