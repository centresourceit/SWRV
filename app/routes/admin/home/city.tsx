 ...
 * @returns {Array} An array of link objects, each containing a "rel" property for the relationship type
 * and a "href" property for the URL of the stylesheet.
 */
...
/**
 * Loader function that retrieves the city data from the server.
 * @param {LoaderArgs} props - The loader arguments.
 * @returns {Promise<{ city: string }>} - A promise that resolves to an object containing the city data.
 */
export const loader: LoaderFunction = async (props: LoaderArgs) => {
    ...
    return json({ city: city.data.data });
}
...
const City = () => {
    ...
    const pagination = usePagination(city);
    ...
    /**
     * Renders a component that displays a modal with information about a specific item, allows for item deletion, and provides a form for editing the item.
    ...
    return (
        <>
            ...
            <div className="grow bg-[#1b2028] my-2 rounded-md p-4 w-full">
                <div className="flex">
                    <h1 className="text-white font-medium text-xl">City</h1>
                ...
                <div className="overflow-x-hidden no-scrollbar">
                    <div className="bg-[#31353f]  rounded-md flex px-4 py-2 my-2 text-white font-medium text-md flex-nowrap">
                        ...
                        <div className="w-44">CityName</div>
                        <div className="grow"></div>
